...
import com.telecom.project.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        String userDept = userRegisterRequest.getUserDept();
        String userName = userRegisterRequest.getUserName();
        String email = userRegisterRequest.getEmail();

        if (StringUtils.isAnyBlank(userAccount, userPassword, checkPassword, userDept, userName)) {
            return null;
        }
        long result = userService.userRegister(userAccount, userPassword, checkPassword, userDept, userName,email);
    ...
    public BaseResponse<Boolean> updatePwd(HttpServletRequest request,@RequestBody PwdUpdateRequest pwdUpdateRequest){
